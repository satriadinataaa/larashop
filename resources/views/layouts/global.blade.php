...
href="{{route('home')}}"> Larashop </a>
 ...
 <input class="border-dark bg-primary-darkest form-control dmd-block w-50 ml-3 mr-2" type="text" placeholder="Search" arialabel="Search">
...
mb-4" type="text" placeholder="Search" aria-label="Search" />
 <li><a href="{{route('users.index')}}"><span class="oi oi-home"></span>
Home</a></li>
<li>
